...
public class CalculatorSoapProxy implements org.wsdl.calculator.CalculatorSoap {
  private String _endpoint = null;
  private org.wsdl.calculator.CalculatorSoap calculatorSoap = null;
  ...
  private void _initCalculatorSoapProxy() {
    try {
      calculatorSoap = (new org.wsdl.calculator.CalculatorLocator()).getCalculatorSoap();
  ...
  public org.wsdl.calculator.CalculatorSoap getCalculatorSoap() {
    if (calculatorSoap == null)
      _initCalculatorSoapProxy();
